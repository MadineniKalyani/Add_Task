...
const handleEdit = () => {
  ...
  return (
    <>
     ...
     <> {!isEditableBtn? <> <Button  variant="contained" color="success" onClick={()=>handleAdd()}>Add</Button> &nbsp;&nbsp;</>:''}<br></br><br></br><br></br>&nbsp;&nbsp;
    <>  {list.length > 0 ? (<><Button variant="contained" color="primary" onClick={handleAllUsers}>All users</Button>&nbsp;&nbsp;
      ...
      {((list.length > 0 && inputList.length === 0 && !isEditableBtn)|| Users )?
      ...
      <TableContainer component={Paper}>&nbsp;&nbsp;&nbsp;&nbsp;
        <Container>
          ...
          <TableRow><Button variant="contained" onClick={handleEdit}>Edit</Button></TableRow> 
